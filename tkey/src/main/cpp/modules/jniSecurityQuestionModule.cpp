...
Java_com_web3auth_tkey_ThresholdKey_Modules_SecurityQuestionModule_jniSecurityQuestionModuleGenerateShareStoreResult(
...
Java_com_web3auth_tkey_ThresholdKey_Modules_SecurityQuestionModule_jniSecurityQuestionModuleInputShare(
        JNIEnv *env, __attribute__((unused)) jclass clazz, jobject threshold_key,
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_web3auth_tkey_ThresholdKey_Modules_SecurityQuestionModule_jniSecurityQuestionModuleChangeQuestionAndAnswer(
        JNIEnv *env, __attribute__((unused)) jclass clazz, jobject threshold_key,
        jstring questions, jstring answer,
        jstring curveN,
        jthrowable error) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_web3auth_tkey_ThresholdKey_Modules_SecurityQuestionModule_jniSecurityQuestionModuleStoreAnswer(
        JNIEnv *env, __attribute__((unused)) jclass clazz, jobject threshold_key,
        jstring answer, jstring curveN,
        jthrowable error) {
    int errorCode = 0;
...
Java_com_web3auth_tkey_ThresholdKey_Modules_SecurityQuestionModule_jniSecurityQuestionModuleGetAnswer(
        JNIEnv *env, __attribute__((unused)) jclass clazz, jobject threshold_key,
        jthrowable error) {
    int errorCode = 0;
    int *error_ptr = &errorCode;
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_web3auth_tkey_ThresholdKey_Modules_SecurityQuestionModule_jniSecurityQuestionModuleGetQuestions(
        JNIEnv *env, __attribute__((unused)) jclass clazz, jobject threshold_key,
        jthrowable error) {
    int errorCode = 0;
    int *error_ptr = &errorCode;
